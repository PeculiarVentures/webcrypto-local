  ...
  >
    <defs>
      <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="a">
        <stop stopColor="#4DA3FC" offset="0%" />
        <stop stopColor="#027EFF" offset="100%" />
      </linearGradient>
      <linearGradient x1="50%" y1="100%" x2="50%" y2="0%" id="c">
        <stop stopColor="#49A1FC" offset="0%" />
        <stop stopColor="#0680FF" offset="100%" />
      </linearGradient>
