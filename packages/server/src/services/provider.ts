...
import { NotifyEvent, NotifyEventHandler, Service } from "./service";
...
export class ProviderService extends Service<LocalProvider> {
  ...
  public on(event: "notify", cb: NotifyEventHandler): this;
  ...
  public once(event: "notify", cb: NotifyEventHandler): this;
