...
import { CryptoCertificateProto } from "../core/protos/certstorage";
...
export function isCryptoKey(data: any): data is CryptoKeyProto {
  return data instanceof CryptoKeyProto;
}

export function isCryptoCertificate(data: any): data is CryptoCertificateProto {
